      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '28px 20px' }} className="page-animate">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 14 }}>
          ...
          <Link href="/fantasy" style={{ textDecoration: 'none' }}>
            <div className="hover-card hover-card-green" style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden', cursor: 'pointer' }}>
              <div style={{ height: 3, background: 'linear-gradient(90deg, var(--green), var(--cyan))' }} />
              <div style={{ padding: '18px 20px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                  <div style={{ fontSize: 32 }}>🏆</div>
                  <span style={{ background: 'rgba(0,240,117,.1)', color: 'var(--green)', border: '1px solid rgba(0,240,117,.25)', borderRadius: 4, padding: '2px 8px', fontSize: 10, fontWeight: 700, textTransform: 'uppercase' }}>
                    Em breve
                  </span>
                </div>
                ...
                <div style={{ color: 'var(--green)', fontSize: 13, fontWeight: 700 }}>Ver campeonatos →</div>
              </div>
            </div>
          </Link>
          ...
          <Link href="/comunidade" style={{ textDecoration: 'none' }}>
            <div className="hover-card hover-card-orange" style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden', cursor: 'pointer' }}>
              <div style={{ height: 3, background: 'linear-gradient(90deg, var(--orange), var(--gold))' }} />
              <div style={{ padding: '18px 20px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                  <div style={{ fontSize: 32 }}>🎮</div>
                  <span style={{ background: 'rgba(249,115,22,.1)', color: 'var(--orange)', border: '1px solid rgba(249,115,22,.25)', borderRadius: 4, padding: '2px 8px', fontSize: 10, fontWeight: 700, textTransform: 'uppercase' }}>
                    Disponível
                  </span>
                </div>
                <h2 className="font-condensed" style={{ fontWeight: 900, fontSize: 20, color: 'var(--white)', textTransform: 'uppercase', letterSpacing: '.03em', marginBottom: 6 }}>
                ...
                <div style={{ color: 'var(--orange)', fontSize: 13, fontWeight: 700 }}>Ver torneios →</div>
              </div>
            </div>
          </Link>
        </div>
