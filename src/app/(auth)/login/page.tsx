    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ width: '100%', maxWidth: 400, position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 14, overflow: 'hidden' }}>
          ...
          <div style={{ padding: '24px 24px 20px' }}>
            ...
            <button
              ...
              onMouseEnter={e => (e.currentTarget.style.boxShadow = '0 0 0 1px rgba(103,193,245,.5), 0 0 16px rgba(103,193,245,.15)')}
              onMouseLeave={e => (e.currentTarget.style.boxShadow = '0 0 0 1px rgba(103,193,245,.2)')}
            >
              <SteamIcon />
              Entrar com Steam
            </button>
            ...
            <form action={formAction} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                <input name="email" type="email" required placeholder="seu@email.com" style={{
                  ...
                  padding: '10px 14px', color: 'var(--text)', fontSize: 14, fontFamily: 'inherit', outline: 'none', width: '100%',
                }} />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
        ...
        <p style={{ textAlign: 'center', fontSize: 10, color: 'var(--text3)', marginTop: 12 }}>
          Login Steam requer habilitação no painel Supabase → Auth → Providers
        </p>
      </div>
    </div>
  )
